        ...
        <div className="w-full h-auto flex flex-col justify-center items-center my-20">
            <section className='w-full h-auto'>
                <div className=' absolute left-[15%] sm:left-[20%]'>
                    <h1 className='text-[1.5rem] sm:text-[2rem] md:text-[3rem] lg:text-[4rem]'>About our community</h1>
                </div>
                ...
                <div className='absolute md:w-[40%] text-center p-10 bg-white md:left-[55%] translate-y-[100%] sm:translate-y-[160%] md:translate-y-[50%] lg:translate-y-[140%] rounded-lg'>
